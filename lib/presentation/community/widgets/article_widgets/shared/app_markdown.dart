...
class AppMarkdownState extends State<AppMarkdown> {
  ...
  String get displayedText =>
      widget.hasReadMore && !showFullText && widget.text.length > 500
        ...
        children: [
          Markdown(
            ...
            onTapLink: (text, href, title) =>
                href != null ? launchUrlString(href) : {},
            styleSheet: MarkdownStyleSheet(
              blockquote: AppTextStyles.black60Medium13,
              checkbox: AppTextStyles.primaryBold18,
              p: AppTextStyles.grayMedium16
                  .copyWith(height: widget.lineHeight ?? 1.3),
              a: AppTextStyles.primarySemiBold16
