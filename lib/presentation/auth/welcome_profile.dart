...
//   String? get signInName => widget.signInName;

//   String? get mobile => widget.mobile;

//   String? get mobileIsoCode => widget.mobileIsoCode;
...
//     super.initState();
//     logIt.verbose(
//       'WelcomeProfilePage() mobile: $mobile, mobileIsoCode: $mobileIsoCode',
//     );
//     // context.read<ProfileUserFormCubit>().getProfileUser();
...
//                         title:
//                             'Hey, ${state.userModelForEditing.firstName != null && state.userModelForEditing.firstName!.isNotEmpty ? state.userModelForEditing.firstName : (signInName ?? '')}',
...
//                                     //   month: state.userModelForEditing.birthday?.month,
//                                     //   year: state.userModelForEditing.birthday?.year,
//                                     // ),
//                                     // SizedBox(height: $constants.insets.sm),
//                                     //*------------------ GENDER ---------------------//
...
//                       ),
//                       child: state.isLoading || state.isGetUserProfileLoading
//                           ? Center(
