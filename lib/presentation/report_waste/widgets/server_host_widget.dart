...
// class ServerHostWidget extends StatefulWidget {
//   const ServerHostWidget({super.key});
...
//         text: get<ServerHostHandler>().getUri("").toString());
//   }
...
//     final currentUriString = watchStream(
//                 (ServerHostHandler s) => s.getUriStringStream(),
...
//     get<ServerHostHandler>()
//         .setSchemeHost(uri.scheme, uri.host, uri.hasPort ? uri.port : null);
